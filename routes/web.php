...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('henkaten')->name('henkaten.')->group(function () {
        ...
        // Rute untuk tombol "Change" dari master material
        Route::get('/material/create-change/{id_material}', [HenkatenController::class, 'createMaterialChange'])
            ->name('material.createChange');

        // Rute store change material
        Route::post('/material/store-change', [HenkatenController::class, 'storeMaterialChange'])->name('material.storeChange');

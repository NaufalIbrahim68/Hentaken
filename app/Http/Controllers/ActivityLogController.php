...
class ActivityLogController extends Controller
{
    ...
    {
        // Query stations dengan is_main_operator untuk filter QC/PPIC
        ...
        // Tambahkan variabel untuk konsistensi dengan create view
        $userRole = auth()->user()->role ?? 'Operator';
        $roleLineArea = $log->line_area ?? '';

        // Filter lineAreas berdasarkan role (sama seperti di create)
        if ($userRole === 'Leader FA' || $userRole === 'SubLeader FA') {

                    ...
                    <form
                        ...
                        <div x-data="henkatenForm({
                            ...
                            <fieldset>
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            <label for="line_area" class="block text-sm font-medium text-gray-700">Line
                                                Area
                                                <span x-show="isLeaderFAOrSMT || isQCOrPPIC"
                                                    class="text-red-500">*</span>
                                            </label>

                                            <template x-if="(isLeaderFAOrSMT || isQCOrPPIC || isEditing)">
                                    ...
                                    <div class="bg-white rounded-lg p-4 border-2 border-green-300 shadow-md">
                                        ...
                                        <div class="relative">
                                            <input type="text" id="nama_after" name="nama_after"
                                                x-model="autocompleteQuery" @input.debounce.300ms="searchAfter()"
                                                @focus="openDropdown()" @blur="closeDropdown()" autocomplete="off"
                                            ...
                                            {{-- Loading State --}}
                                            <div x-show="isDropdownOpen && !autocompleteResults.length && selectedGrup"
                                            ...
                                            {{-- No Results --}}
                                            <div x-show="!isDropdownOpen && autocompleteQuery.length >= 2 && !selectedManpowerAfter"
                                ...
                                <button type="button" @click="refreshAfterList()"
                                    ...
                                    <div>
                                        ...
                                        <div
                                            ...
                                            <ul class="list-disc list-inside space-y-1">
                                                ...
                                                <li><strong>Cuti/Tugas Resmi :</strong> Wajib melampirkan surat tugas.
                                                </li>
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if (isset($log) && $log->lampiran)
                                            <div class="mt-2 p-3 bg-gray-50 rounded-md border border-gray-200">
                                                <p class="text-sm text-gray-700 font-medium mb-1">Lampiran 1 saat ini:
                                                </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if (isset($log) && $log->lampiran_2)
                                            <div class="mt-2 p-3 bg-gray-50 rounded-md border border-gray-200">
                                                <p class="text-sm text-gray-700 font-medium mb-1">Lampiran 2 saat ini:
                                                </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if (isset($log) && $log->lampiran_3)
                                            <div class="mt-2 p-3 bg-gray-50 rounded-md border border-gray-200">
                                                <p class="text-sm text-gray-700 font-medium mb-1">Lampiran 3 saat ini:
                                                </p>
        ...
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.data('henkatenForm', (config) => ({
                ...
                async init() {
                    ...
                    if (this.selectedStation && this.selectedLineArea && (this.selectedGrup || this
                            .isQCOrPPIC)) {
                ...
                fetchStations(resetStation = true) {
                    if (resetStation) {
                        const currentStationExists = this.filteredStationList.some(st => st.id == this
                            .selectedStation);
                ...
                async fetchManpowerBefore() {
                    ...
                    if (!this.selectedStation || !this.selectedLineArea || (requiresGroup && !this
                            .selectedGrup)) {
                        this.manpowerBefore = {
                            id: '',
                            nama: ''
                    ...
                    try {
                        ...
                        this.manpowerBefore = data && data.id ? {
                            ...
                            id: '',
                            nama: 'Tidak ada Man Power bertugas'
                        };
                    } catch (e) {
                ...
                async validateAfter() {
                    ...
                    if (!dateRegex.test(effectiveDate) || !dateRegex.test(endDate)) {
                        ...
                        this.afterValid =
                            true; // Don't block form if dates are invalid, let backend validation handle it
                        return;
                    }

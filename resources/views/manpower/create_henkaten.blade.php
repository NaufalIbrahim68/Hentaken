                        ...
                        >
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="line_area" name="line_area" required {{-- <-- SUDAH ADA --}}
                                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="station_id" name="station_id" required {{-- <-- SUDAH ADA --}}
                                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date" id="end_date" name="end_date" value="{{ old('end_date') }}"
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                            {{-- Saya biarkan ini opsional, tambahkan 'required' jika wajib --}}
                                    </div>
                            ...
                            <div class="mb-6 mt-6">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="4"
                                          ...
                                          required>{{ old('keterangan') }}</textarea> {{-- <-- DITAMBAHKAN 'required' --}}
                            </div>

<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('henkaten.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- 
                            PERUBAHAN 1: 
                            Menambahkan x-data untuk membungkus kedua dropdown.
                            Ini akan menginisialisasi Alpine dengan data 'old()' jika ada,
                            dan $stations (yang seharusnya dikirim dari controller).
                        --}}
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6"
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="mb-4">
                                        ...
                                        {{-- 
                                            PERUBAHAN 2: 
                                            Menambahkan x-model dan @change ke dropdown Line Area.
                                        --}}
                                        <select id="line_area" name="line_area" required
                                            ...
                                            @foreach ($lineAreas as $area)
                                                {{-- 
                                                    PERUBAHAN 3: 
                                                    Menggunakan :selected untuk menangani 'old' input via Alpine.
                                                --}}
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    {{-- 
                                        PERUBAHAN 4: 
                                        Menambahkan x-model dan :disabled ke dropdown Station.
                                    --}}
                                    <select id="station_id" name="station_id" required
                                        ...
                                        {{-- 
                                            PERUBAHAN 5: 
                                            Mengganti @foreach dengan <template x-for> Alpine.js.
                                            Ini akan mengisi dropdown secara dinamis.
                                        --}}
    ...
    <script>
        ...
        {{-- 
            PERUBAHAN 6: 
            Menambahkan fungsi dependentDropdowns baru untuk Alpine.js
        --}}

                                    ...
                                    <div>
                                        ...
                                        @if (isset($log))
                                            <div class="mb-4">
                                                ...
                                                <select id="grup" name="grup" x-model="selectedGrup" @change="fetchManpowerBefore"
...
<template x-if="(isLeaderFAOrSMT || isQCOrPPIC)">
                                                <select id="line_area_leader" name="line_area" x-model="selectedLineArea" @change="fetchStations"
                                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
...
<template x-if="!(isLeaderFAOrSMT || isQCOrPPIC)">
                                                <div>
                                                    <input type="text" id="line_area_display" :value="selectedLineArea" readonly
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <template x-if="(isLeaderFAOrSMT || isQCOrPPIC)">
                                                <select id="station_id_dropdown" name="station_id" x-model="selectedStation" @change="fetchManpowerBefore"
                                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                                    <option value="">-- Pilih Station --</option>
                                                    <template x-for="st in filteredStationList" :key="st.id"> 
                                                        <option :value="st.id" x-text="st.station_name"></option>
                                                    </template>
                                                </select>
                                            </template>
                                            ...
                                            <template x-if="!isLeaderFAOrSMT && !isQCOrPPIC">
                                                <div>
                                                    <input type="text" id="station_name_display" :value="currentStationName"
                                                            readonly
                                                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm bg-gray-100 text-gray-600">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                    <div class="bg-white rounded-lg p-4 border-2 border-blue-300 shadow-md">
                                        ...
                                        <input type="text" id="nama_before_display" x-model="manpowerBefore.nama" readonly
                                    ...
                                    <div class="bg-white rounded-lg p-4 border-2 border-green-300 shadow-md relative">
                                        ...
                                        <ul x-show="autocompleteResults.length > 0"
                                            ...
                                            <template x-for="item in autocompleteResults" :key="item.id">
                                                <li @click="selectAfter(item)" class="px-4 py-2 cursor-pointer hover:bg-green-100" x-text="item.nama"></li>
                                            </template>
                                        </ul>
                                ...
                                {{-- Lampiran --}}
                                <div class="mb-6 mt-6">
                                    <label for="lampiran" class="block text-gray-700 text-sm font-bold mb-2">Lampiran (Wajib untuk Izin/Sakit)</label>
                                    ...
                                    @if (isset($log) && $log->lampiran)
                                        <div class="mt-2 p-3 bg-gray-50 rounded-md border border-gray-200">
                                            ...
                                            <a href="{{ asset('storage/' . $log->lampiran) }}" target="_blank" class="text-blue-600 hover:text-blue-800 hover:underline">
                            ...
                            <div class="flex items-center justify-end space-x-4 pt-4 border-t mt-6">
                                ...
                                <p x-show="!afterValid" class="text-red-500 text-sm mt-1">Karyawan ini sudah dijadwalkan sebagai Man Power After untuk shift ini.</p>
                            </div>

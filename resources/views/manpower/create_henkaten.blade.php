                    ...
                    <form action="{{ route('manpower.henkaten.store', $man_power->id) }}" method="POST">
                     ...
                     {{-- Nama Karyawan Before & After (Full Width) --}}
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white rounded-lg p-4 border-2 border-blue-300 shadow-md">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <label for="nama_before" class="text-gray-700 text-sm font-bold">Nama Karyawan Before</label>
                                    </div>
                                    <input type="text" id="nama_before" name="nama_before" value="{{ old('nama_before', $man_power->nama) }}" class="w-full py-3 px-4 text-gray-700 bg-gray-100 border-2 border-gray-300 rounded-lg font-semibold focus:outline-none cursor-not-allowed" readonly>
                                ...
                                <div class="bg-white rounded-lg p-4 border-2 border-green-300 shadow-md">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <label for="nama_after" class="text-gray-700 text-sm font-bold">Nama Karyawan After</label>
                                    </div>
                                    <input type="text" id="nama_after" name="nama_after" value="{{ old('nama_after') }}" class="w-full py-3 px-4 text-gray-700 bg-white border-2 border-green-300 rounded-lg font-semibold focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition duration-200" placeholder="Masukkan nama karyawan after">
                                    @error('nama_after') 
                        ...
                        <div class="mb-6">
                         ...
                         {{-- [BARU] Input untuk Lampiran Foto --}}
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Format yang diizinkan: JPG, PNG. Maksimal 2MB.</p>
                            @error('lampiran') <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p> @enderror
                        </div>

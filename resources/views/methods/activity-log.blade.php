            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <form action="{{ route('activity.log.method') }}" method="GET"
                            ...
                            <div>
                                ...
                                <select name="line_area" id="line_area" class="mt-1 block w-40 rounded-md border-gray-300 shadow-sm 
                                    ...
                                    {{-- Pastikan $lineAreas dan $line_area dikirim dari controller --}}
                                    @isset($lineAreas)
                            ...
                            <button type="submit" 
                                    formaction="{{ route('activity.log.method.pdf') }}" {{-- UBAH: route ke .pdf --}}
                                    formtarget="_blank"
                ...
                @if ($logs->isEmpty() && ($created_date || $line_area))
                    <div class="mb-4 p-4 rounded-md bg-yellow-100 border border-yellow-400 text-yellow-700 mx-6">
                        Tidak ada data Henkaten Method untuk filter yang dipilih.
                    </div>
                @endif
                                    ...
                                    <td class="py-2 px-3">
                                        @php
                                            ...
                                            if($status == 'Approved') {
                                                ...
                                                // UBAH: Sesuaikan dengan status Anda (Pending/pending)

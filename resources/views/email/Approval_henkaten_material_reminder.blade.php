...
<p>Ada <strong>{{ $total }}</strong> data <strong>Material Henkaten</strong> yang masih Pending lebih dari 7 hari.</p>
...
<table border="1" cellpadding="6" cellspacing="0" width="100%" style="border-collapse: collapse; font-size: 13px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $item->description_before ?? '-' }}</td>
            <td>{{ $item->description_after ?? '-' }}</td>

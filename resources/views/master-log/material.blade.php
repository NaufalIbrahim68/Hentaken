            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-end mb-4">
                        <form action="{{ route('activity.log.master.material') }}" method="GET" class="flex items-end space-x-2">
                            ...
                            <a href="{{ route('activity.log.master.material') }}" class="py-2 px-6 border border-gray-300 shadow-sm text-sm font-medium rounded-md 

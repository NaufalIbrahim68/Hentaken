        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-end mb-4">
                    <form action="{{ route('master.log.machine') }}" method="GET" class="flex items-end space-x-2">
                        <div>
                        ...
                        <a href="{{ route('master.log.machine') }}" class="py-2 px-6 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-100 focus:outline-none transition">
                            Reset
                        </a>
                    </form>
                </div>

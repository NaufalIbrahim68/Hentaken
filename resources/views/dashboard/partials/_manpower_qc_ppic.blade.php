...
<div class="bg-white shadow rounded p-1 flex flex-col">
    {{-- HEADER: JUDUL (TANPA FILTER GRUP untuk QC/PPIC) --}}
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        @if (isset($dataManPowerKosong) && $dataManPowerKosong)
            <div class="w-full text-center text-gray-500 py-10">
                <p class="text-sm font-medium">Tidak ada Man Power data</p>
            </div>
        @else
            <div class="w-full">
    ...
    <div class="border-t mt-2 pt-2">
        <div class="flex items-center gap-1">
            ...
            <div id="shiftChangeContainer" class="flex-grow overflow-x-auto scrollbar-hide scroll-smooth">
                @php
                    // QC/PPIC: Filter by currentGroup and PENDING status
                    if ($currentGroup) {
                ...
                @else
                    <div class="text-center text-xs text-gray-400 py-4">No Actived Man Power Henkaten</div>
                @endif
            </div>

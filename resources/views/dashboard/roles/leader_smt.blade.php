<x-app-layout>
    ...
    <div class="w-full h-screen flex flex-col px-3 py-1">
        ...
        <div class="grid grid-cols-2 gap-3 h-[92vh]">
            ...
            {{-- MAN POWER --}}
            @include('dashboard.partials._man_power_smt')

            {{-- METHOD  --}}
            @include('dashboard.partials._method_smt')

            {{-- MACHINE --}}
            @include('dashboard.partials._machine_smt')

            {{-- MATERIAL --}}
            @include('dashboard.partials._material_smt')

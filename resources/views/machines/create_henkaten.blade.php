<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- DIUBAH: Form action (asumsi route) --}}
                    <form action="{{ route('henkaten.machine.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        {{-- Wrapper Alpine.js --}}
                        {{-- DIUBAH: Konfigurasi x-data disederhanakan untuk machine --}}
                            ...
                            <fieldset :disabled="grupError">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        {{-- ================================================== --}}
                                        {{-- BARU: Kategori Henkaten Machine --}}
                                        {{-- ================================================== --}}
                                        <div class="mb-4">
                                            ...
                                            <select id="category" name="category" x-model="selectedCategory"
                                                ...
                                                <option value="Machine & Jig">Machine & Jig</option>
                                    ...
                                    {{-- Kolom Kanan (Tanggal & Waktu - Tidak berubah) --}}
                                    <div>
                                        <div class="mb-4">
                                ...
                                {{-- ================================================== --}}
                                {{-- DIUBAH: Before & After untuk Machine (Input Manual) --}}
                                {{-- ================================================== --}}
    ...
    {{-- DIUBAH: Script Alpine disederhanakan, menghapus logika Man Power --}}
    <script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('henkatenForm', (config) => ({
            ...
            selectedCategory: config.oldCategory || '', // BARU
            stationList: [],
            ...
            init() {
                ...
                // Jika ada old data line area, fetch station-nya
            ...
            async fetchStations(resetStation = true) {
                ...
                try {
                    ...
                    // Jika tidak reset, 'selectedStation' akan otomatis terikat ke old value dari config
                } catch (err) {
